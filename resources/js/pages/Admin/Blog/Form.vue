      ...
      <div class="space-y-5 lg:sticky lg:top-20">
        ...
        <div class="bg-white rounded-2xl border border-gray-200 p-5 space-y-4">
          ...
          <div>
            ...
            <input v-model="form.featured_image" type="url" class="input"
                   placeholder="https://..." />
            <div v-if="form.featured_image" class="mt-2 rounded-xl overflow-hidden border border-gray-200 aspect-video bg-gray-100">
              <img :src="form.featured_image" class="w-full h-full object-cover"
          ...
          <div>
            ...
            <input v-model="form.alt_text" type="text" class="input"
